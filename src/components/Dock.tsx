...
const IconContainer = ({
  ...
  const widthTransform = useTransform(distance, [-100, 0, 100], [48, 72, 48]);
  const heightTransform = useTransform(distance, [-100, 0, 100], [48, 72, 48]);
  const yTransform = useTransform(distance, [-100, 0, 100], [0, -20, 0]);
...
export const Dock: React.FC<DockProps> = ({ className = "" }) => {
  ...
  // Load hero data for social links
